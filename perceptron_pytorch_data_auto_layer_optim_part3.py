...
if __name__ == '__main__':
	...
	hidden_layer_size1 = 350
	hidden_layer_size2 = 175
	hidden_layer_size3 = 80
	...
	shallow_n = torch.nn.Sequential(
		torch.nn.Linear(data_train.shape[1],hidden_layer_size1),
		torch.nn.Sigmoid(),
        torch.nn.Linear(hidden_layer_size1,hidden_layer_size2),
        torch.nn.SELU(),
        torch.nn.Linear(hidden_layer_size2,hidden_layer_size3),
		torch.nn.ReLU(),
		torch.nn.Linear(hidden_layer_size3,label_train.shape[1])
	)
